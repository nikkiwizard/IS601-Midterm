        ...
        while True:
            try:
                ...
                if command == 'help':
                    ...
                    print("\nAvailable commands:")
                    print("  add, subtract, multiply, divide, modulus, integer_division, power, root - Perform calculations")
                ...
                if command in ['add', 'subtract', 'multiply', 'divide', 'modulus', 'integer_division', 'power', 'root']:
