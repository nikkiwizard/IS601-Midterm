...
class TestModulus(BaseOperationTest):
    ...
    valid_test_cases = {
        ...
        "decimal_numbers": {"a": "7.5", "b": "2.5", "expected": "0.0"},
        "zero_remainder": {"a": "8", "b": "4", "expected": "0"},
    }
    invalid_test_cases = {
        "divide_by_zero": {
            "a": "5",
...
class TestIntegerDivision(BaseOperationTest):
    ...
    valid_test_cases = {
        ...
        "negative_numbers": {"a": "-7", "b": "2", "expected": "-3"},
        "decimal_numbers": {"a": "7.9", "b": "2", "expected": "3"},
        "zero_result": {"a": "4", "b": "2", "expected": "2"},
    }
    invalid_test_cases = {
        "divide_by_zero": {
            "a": "5",
...
class TestAbsoluteDifference(BaseOperationTest):
    ...
    valid_test_cases = {
        "positive_difference": {"a": "8", "b": "3", "expected": "5"},
        "negative_difference": {"a": "3", "b": "8", "expected": "5"},
        "equal_values": {"a": "5", "b": "5", "expected": "0"},
        "decimal_values": {"a": "5.5", "b": "2.25", "expected": "3.25"},
    }
    invalid_test_cases = {}
